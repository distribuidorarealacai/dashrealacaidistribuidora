#!/usr/bin/env python3
"""
dash_flask_ofc.py  (v9 - final corrigido)
"""
...
<hr class="footer-divider">
<div class="footer-copy">(c) 2026 Real Acai Distribuidora - Todos os direitos reservados<br>Desenvolvido por Gabriel Freitas - Desenvolvedor Autonomo - v1.0.0 - Ultima atualizacao: 14/08/2026</div>
</div>
</div>
<script>
