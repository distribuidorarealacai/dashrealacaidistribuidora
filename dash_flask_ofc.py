...
<div class="card">
<div class="logo">
<img src="WhatsApp Image 2026-08-18 at 09.16.29.jpeg" alt="Logo Real Acai" onerror="this.style.display='none'" style="max-height:100px;max-width:220px;object-fit:contain">
...
/* HERO */
.hero{min-height:100vh;display:flex;align-items:center;justify-content:center;position:relative;background:linear-gradient(135deg,rgba(20,10,30,0.88),rgba(76,29,149,0.75)),url('WhatsApp Image 2026-08-18 at 09.16.29.jpeg') center/cover no-repeat fixed}
