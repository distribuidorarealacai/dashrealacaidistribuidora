...
var pv={},pl={},pd={};abs.forEach(function(a){
var n=a.veiculo;
var v=parseFloat(a.valor)||0;
var l=parseFloat(a.litros)||0;
if(!pv[n])pv[n]=0; pv[n]+=v;
if(!pl[n])pl[n]=0; pl[n]+=l;
if(!pd[a.data])pd[a.data]=0; pd[a.data]+=v;});
var nAbs=abs.length;
